...
𝘚𝘢𝘺𝘢 𝑺𝒖𝒏𝒈 𝑱𝒊𝒏𝒘𝒐𝒐 𝘉𝘰𝘵 𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱 𝘠𝘢𝘯𝘨 𝘉𝘪𝘴𝘢 𝘔𝘦𝘮𝘣𝘢𝘯𝘵𝘶 𝘈𝘯𝘥𝘢 𝘔𝘦𝘮𝘣𝘶𝘢𝘵 𝘚𝘵𝘪𝘤𝘬𝘦𝘳, 𝘋𝘰𝘸𝘯𝘭𝘰𝘢𝘥 𝘝𝘪𝘥𝘦𝘰/𝘈𝘶𝘥𝘪𝘰 𝘛𝘪𝘬𝘵𝘰𝘬, 𝘋𝘰𝘸𝘯𝘭𝘰𝘢𝘥 𝘝𝘪𝘥𝘦𝘰/𝘈𝘶𝘥𝘪𝘰 𝘠𝘰𝘶𝘵𝘶𝘣𝘦, 𝘔𝘦𝘮𝘣𝘶𝘢𝘵 𝘓𝘰𝘨𝘰 𝘛𝘦𝘹𝘵 𝘗𝘳𝘰/𝘗𝘩𝘰𝘵𝘰𝘰𝘹𝘺/𝘌𝘱𝘩𝘰𝘵𝘰360, 𝘋𝘢𝘯 𝘓𝘢𝘪𝘯-𝘭𝘢in.
All Menu
🅞 = Khusus Owner
🅖 = Khusus Group
🅕 = Free User
...
${hituet+=1} ${prefix}sungstick 🅞
${hituet+=1} ${prefix}sungteks 🅞
${hituet+=1} ${prefix}sungitem 🅞
${hituet+=1} ${prefix}sunglog 🅞
${hituet+=1} ${prefix}sungkontak 🅞
${hituet+=1} ${prefix}sungloc 🅞
${hituet+=1} ${prefix}sungdoc 🅞
${hituet+=1} ${prefix}sungvn 🅞
